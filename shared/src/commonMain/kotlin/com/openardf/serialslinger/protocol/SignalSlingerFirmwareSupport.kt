...
object SignalSlingerFirmwareSupport {
    ...
    private val sharedVerificationReadbackCommands: Map<SettingKey, List<String>> = mapOf(
        ...
        SettingKey.CURRENT_TIME to listOf("CLK", "EVT"),
        SettingKey.START_TIME to listOf("CLK", "EVT"),
        SettingKey.FINISH_TIME to listOf("CLK", "EVT"),
        SettingKey.DAYS_TO_RUN to listOf("CLK", "EVT"),
    ...
    private val arduconProfile = SignalSlingerFirmwareProfile(
        ...
        capabilities = DeviceCapabilities(
            ...
            supportsEventTypeEditing = false,
            supportsFoxRoleEditing = true,
            supportsIdCodeSpeedEditing = true,
