...
class SessionHistoryTest {
    ...
    @Test fun parsesDeviceHistoryAndDeduplicatesRefreshes() {
        ...
        state = DeviceSessionWorkflow.ingestReportLines(state, listOf(
            ...
            "* Session history: v=1 count=1 capacity=6", record, record,
        ))
        ...
        state = DeviceSessionWorkflow.ingestReportLines(state, listOf("* Session history: v=1 count=0 capacity=6"))
    ...
    @Test fun rejectsMalformedAndUnknownVersionReports() {
        ...
        assertNull(SignalSlingerProtocolCodec.parseReportLine("* Session history: v=1 count=7 capacity=6"))
    }
}
